			...
			base.instance_eval do
				...
				index :as => :sortable do
					...
					actions defaults: false do |page|
						...
						(link_to edit_js_admin_page_path(page), remote: :true, class: "mx-2 text-success", "data-bs-toggle": "tooltip", "data-placement": "top", "data-html": true, title: "edit page <b>#{page.title}</b>" do icon('fas', 'edit') end)
