class Attachment < ApplicationRecord
	...
	store :attachment_properties, accessors: [ :image_quality, :background_image_size, :background_image_position, :background_image_color, :url_image, :price, :series ], coder: JSON
