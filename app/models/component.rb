class Component < ApplicationRecord
  ...
  COMPONENT_LAYOUT=["banner", "banner_text","categories_products","text_base","text_image_base","text_product_base", "space", "list_images", "typing_animation", "gallery_images", "products_by_category"]
