ActiveAdmin.register Product do
  ...
  images_attributes: [:id, :title, :url, :note, :asset, :active, :layout_type, :alt, :image_quality, :background_image_size, :background_image_position, :background_image_color, :price, :series, :url_image, :_destroy] 
