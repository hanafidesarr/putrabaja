ActiveAdmin.register Page do
  ...
  components_attributes: [:id, :name, :layout, :description, :position, :url_product, :url_text, :_destroy, attachments_attributes: [:id, :asset, :content_type, :note, :title, :_destroy]], # *note add id for disable duplicate when attribute updated
