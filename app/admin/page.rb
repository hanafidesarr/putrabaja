ActiveAdmin.register Page do
  ...
  permit_params :title, :active, :description, :layout, :slug, :_destroy,
  ...
  list_images_yml[:properties], typing_animation_yml[:properties], gallery_images_yml[:properties],
  ...
  space_yml[:active_fields], list_images_yml[:active_fields], typing_animation_yml[:active_fields], gallery_images_yml[:active_fields],
