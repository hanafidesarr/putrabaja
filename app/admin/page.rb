ActiveAdmin.register Page do
  ...
  images_attributes: [:id, :active, :asset, :content_type, :note, :title, :url_product, :layout_type, :image_quality, :background_image_size, :background_image_position, :background_image_color, :url, :url_image, :price, :series, :alt, :_destroy]], # *note add id for disable duplicate when attribute updated
  images_attributes: [:id, :active, :asset, :content_type, :note, :title, :layout_type, :image_quality, :background_image_size, :background_image_position, :background_image_color, :url_image, :price, :series, :_destroy] # *note add id for disable duplicate when attribute updated 
