ActiveAdmin.register Page do
  ...
  permit_params :title, :active, :description, :layout, :slug, :background_body_color, :text_body_color, :_destroy, Page.stored_attributes[:header_desktop_properties], Page.stored_attributes[:header_mobile_properties], Page.stored_attributes[:seo_page_properties],
  ...
  split_product_showcase_yml[:properties], modern_slide_in_yml[:properties],
  ...
  vertical_carousel_frame_yml[:active_fields],split_product_showcase_yml[:active_fields], modern_slide_in_yml[:active_fields],

  images_attributes: [:id, :active, :asset, :content_type, :note, :title, :url_product, :layout_type, :image_quality, :background_image_size, :background_image_position, :background_image_color, :url, :url_image, :url_image_thumb, :price, :series, :alt, :_destroy]], # *note add id for disable duplicate when attribute updated
  images_attributes: [:id, :active, :asset, :content_type, :note, :title, :layout_type, :image_quality, :background_image_size, :background_image_position, :background_image_color, :url_image, :url_image_thumb, :price, :series, :_destroy] # *note add id for disable duplicate when attribute updated 
