ActiveAdmin.register Page do
  ...
  banner_flip_effects_rocket_yml = HashWithIndifferentAccess.new(YAML.load_file Rails.root.join('app','views', 'components','modern_slide_in','modern_slide_in.yml'))
  

  permit_params :title, :active, :description, :layout, :slug, :show_title, :background_body_color, :text_body_color, :_destroy, Page.stored_attributes[:header_desktop_properties], Page.stored_attributes[:header_mobile_properties], Page.stored_attributes[:seo_page_properties],
  ...
  split_product_showcase_yml[:properties], modern_slide_in_yml[:properties], banner_flip_effects_rocket_yml[:properties],
  ...
  vertical_carousel_frame_yml[:active_fields],split_product_showcase_yml[:active_fields], modern_slide_in_yml[:active_fields], banner_flip_effects_rocket_yml[:active_fields],
