ActiveAdmin.register Page do
  ...
  subscribe_form_yml[:properties], subscribe_form_modal_yml[:properties], slide_reveal_yml[:properties], annotation_scalize[:properties],
  ...
  slick_slider_multiple_yml[:active_fields], subscribe_form_yml[:active_fields], subscribe_form_modal_yml[:active_fields], slide_reveal_yml[:active_fields], annotation_scalize[:active_fields], 

  images_attributes: [:id, :active, :asset, :content_type, :note, :title, :subtitle, :url_product, :layout_type, :image_quality, :background_image_size, :background_image_position, :background_image_color, :background_image_repeat, :url, :url_image, :url_image_thumb, :price, :series, :alt, :width, :height, :class_image, :position, :style_image, Image.globalize_attribute_names, :_destroy]], # *note add id for disable duplicate when attribute updated
  images_attributes: [:id, :active, :asset, :content_type, :note, :title, :subtitle, :layout_type, :image_quality, :background_image_size, :background_image_position, :background_image_color, :background_image_repeat, :url_image, :url_image_thumb, :price, :series, :width, :height, :class_image, :style_image, :position, Image.globalize_attribute_names, :_destroy] # *note add id for disable duplicate when attribute updated 
