ActiveAdmin.register Page do
  ...
  permit_params :title, :active, :description, :layout, :slug, :show_title, :background_body_color, :text_body_color, :body_layout, :template_categories, :_destroy, Page.stored_attributes[:header_desktop_properties], Page.stored_attributes[:header_mobile_properties], Page.stored_attributes[:seo_page_properties], Page.stored_attributes[:footer],
