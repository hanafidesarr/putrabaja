ActiveAdmin.register Page do
  ...
  subscribe_form_yml[:properties], subscribe_form_modal_yml[:properties], slide_reveal_yml[:properties], annotation_scalize[:properties], nav_list_horizontal[:properties], 
